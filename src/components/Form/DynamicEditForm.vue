          ...
          >
            ...
            >
              ...
              <el-upload
                ...
                "
                :accept="input.allowedExtensions"
                :before-upload="() => false"
              ...
              <hasOneSelection
                ...
                :attribute="input"
                :selected="localFormData[input.name]"
                @select="
      ...
      <el-form-item>
        <div class="w-100 d-flex justify-content-center">
          <el-button class="mx-3" type="primary" @click="onSubmit"
            >تأكيد</el-button
          >
          <el-button type="default" @click="resetForm">إعادة تعيين</el-button>
        </div>
      </el-form-item>
    </Form>
  </div>
    ...
    watch(
      ...
      (newVal) => {
        for (let name in newVal) {
          localFormData.value[name] = newVal[name];
        }
      }
    );
    onMounted(async () => {});
